  ...
  <v-col justify="center" align="center">
    ...
    <v-row class="board-row justify-center" v-if="tab === 0 ? !loadingManaged : !loadingMine">
      ...
      >
          ...
          <v-card-text>
            <v-btn v-if="tab === 0" target="_blank" :href="`https://penguinboard.app/${board.link}/post`" text>Add Post</v-btn>
            ...
            <a v-else target="_blank" :href="`https://penguinboard.app/${board.link}`">
