  ...
  <v-app class="main-fade" dark>
    ...
    >
      <v-toolbar-title v-if="!isMobile">
        <img class="logo" src="~/assets/images/penguin-logo-hz.png" />
      </v-toolbar-title>
      <v-toolbar-title v-else-if="isMobile">
        <img class="logo" src="~/assets/images/penguin-icon.png" />
      </v-toolbar-title>
      <v-spacer />
      <v-btn to="/public" height="60px" style="margin: 3px;" text>Public Boards</v-btn>
      <v-btn height="60px" :disabled="!showSampleRow" style="background-color: #1DA9D3; color: white; margin: 3px;" @click="toggleLogin()" text>Login</v-btn>
    </v-app-bar>
