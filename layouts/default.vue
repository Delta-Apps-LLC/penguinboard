...
export default {
  ...
  async created () {
    ...
    if (this.userData.subscriptionexp != null && parseInt(this.userData.subscriptionexp) < Date.now()) {
      alert('Your one year purchase of unlimited boards has expired. Please purchase another plan on the account settings page.')
